...
with open('/Users/elias/apex-alpha/reports/real_5year_equity_curve.json') as f:
    data = json.load(f)
...
print("✅ Successfully updated HTML and SVG with pure percentage return (%) metrics!")
